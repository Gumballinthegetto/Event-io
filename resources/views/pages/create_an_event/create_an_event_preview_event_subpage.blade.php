...
<body>
    <div class="event-subpage-container event-preview-subpage-container">
        <div class="create-an-event-preview-event-subpage-container">
            <h4 class="preview-event-subpage-title">Event Preview</h4>
        ...
        <div class="event-preview-subpage-back-btn-container">
            <a class="standard-btn bordered-outline-hover-effect" href="{{ route('create_an_event_preview_event') }}">Back</a>
        </div>
    </div>
</body>
</html>